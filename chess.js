...
// tdh1.bgColor =  "white"
// tdh1.innerHTML="&#9814"
// tdh1.style = "font-size:70px"
// tr1.appendChild(tdh1)

function page(){
    var firstColColor = "white";
    for(let i = 0; i < 8; i++) {
        t.appendChild(createRow(firstColColor));
        if (firstColColor === "grey") {
            firstColColor = "white";
        } else if (firstColColor === "white") {
            firstColColor = "grey"
        }
    }
}
// t.appendChild(createRow())

function createRow(firstColColor, pieces, width, height) {
    if (width === undefined) {
        width = 65;
    }
    if (height === undefined) {
    ...
    for(var i=0; i < 8; i++) {
        ...
        if (i < pieces.length) {
            col.innerHTML = pieces[i];
        }
        col.style = "font-size: 70px";
        row.appendChild(col);
    }
    return row;
}
